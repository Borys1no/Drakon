        ...
        <div className="cocteles" style={{ marginTop: "100px" }}>
            ...
            <div className="cocteles-grid">
              <div className="coctel-card">
                ...
                <div className="coctel-back">
                  <h4>{t('drakonTonic')}</h4>
                  <h5>{t('ingredients')}</h5>
                  <p dangerouslySetInnerHTML={{ __html: t('drakonTonicIngredients') }} />
                  <h5>{t('method')}</h5>
                  <p>{t('directMethod')}</p>
                  <h5>{t('glassware')}</h5>
                  <p>{t('balloonGlass')}</p>
            ...
            <div className="coctel-card">
              ...
              <div className="coctel-back">
                <h4>{t('raspSour')}</h4>
                <h5>{t('ingredients')}</h5>
                <p dangerouslySetInnerHTML={{ __html: t('raspSourIngredients') }} />
                <h5>{t('method')}</h5>
                <p>{t('shakeMethod')}</p>
                <h5>{t('glassware')}</h5>
                <p>{t('coupeGlass')}</p>
            ...
            <div className="coctel-card">
              ...
              <div className="coctel-back">
                <h4>{t('lechuza')}</h4>
                <h5>{t('ingredients')}</h5>
                <p dangerouslySetInnerHTML={{ __html: t('lechuzaIngredients') }} />
                <h5>{t('method')}</h5>
                <p>{t('directMethod')}</p>
                <h5>{t('glassware')}</h5>
                <p>{t('shortGlass')}</p>
