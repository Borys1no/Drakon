...
const UserProfile = () => {
    ...
    const [isGoogleUser, setIsGoogleUser] = useState(false); // Estado para verificar si es un usuario de Google
    ...
    return (
        <div>
            ...
            {/* Mostrar la sección de cambio de contraseña solo si no es un usuario de Google */}
            {!isGoogleUser && (
                <>
